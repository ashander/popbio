...
#'@param fate name of the fate column in the stage-fate data frame.  Defaults
#'to "fate"
...
#'\emph{estimated} transtions to the transition matrix (e.g., a transition from
#'seed bank to seedling).  May be repeated.
...
#'true, then a list with 2 items where A=T+F \item{T }{Transition matrix}
