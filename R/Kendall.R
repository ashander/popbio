...
#'beta-binomial vital rates, using a brute force search for the best adjusted
#'estimates from a very large number of combinations of different possible mean
#'and variance values.
#'
#'
...
#'@param grades number of different levels of means and variances to try,
#'default is 1000
...
#'@return A list with estimates and confidence intervals \item{est}{a matrix
#'with 5 columns: (1) estimated mean, (2) Kendall's MLE mean, (3) estimated
#'variance, (4) Kendall's MLE variance, (5) Kendall's unbiased MLE variance.}
...
#'@note Note that it may deliver warning messages of : 'no finite arguments to
#'min; returning Inf', indicating use of very low values for variance, but this
