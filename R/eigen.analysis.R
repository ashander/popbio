...
#'@return A list with 6 items \item{lambda1 }{dominant eigenvalue with largest
#'real part } \item{stable.stage}{proportional stable stage distribution}
...
#'@author Original code by James Holland Jones, Stanford University, Department
#'of Anthropological Sciences, 12 August 2005 at
