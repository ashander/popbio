...
#'@param ... additional arguments passed to \code{\link{projection.matrix}}
#'@return If summary is TRUE, a list with \item{recruits}{ total number of
#'recruits} \item{seed.survival}{ seed survival rate} \item{seed.bank }{ total
#'number of seeds in seed bank } \item{seeds.from.plants}{ total number of new
#'seeds just released from fruits } \item{recruitment.rate}{ recruitment rate
#'calculated as recruits/(seed.bank.size + seeds.from.plants)}
#'\item{A}{projection matrix} \item{lambda}{population growth rate}
#'\item{n}{initial population vector} \item{n1}{final population vector}
#'
#'If summary is FALSE, a data frame with individual fertilities added to the
#'transition data frame only.
