...
#'@param proportions plot proportional changes or total numbers, defaults to
#'proportions.
#'@param legend.coords a \code{\link{legend}} keyword or vector of x,y
#'coordinates, defaults to top-right corner
#'@param ylim the y limits of the plot, defaults to min and max values in
#'stage.vectors
#'@param xlab a label for the x axis
#'@param ylab a label for the y axis
#'@param col vector of line colors, defaults to rainbow(8)
#'@param ... additional options are passed to \code{\link{plot}} function
