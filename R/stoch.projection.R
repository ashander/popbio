...
#'
#'Simulates stochastic growth by projection using whole matrix selection
#'techniques in an independently and identically distributed (iid) environment
#'from a set of 2 or more projection matrices
#'
#'
#'@param matrices a \code{\link{list}} with two or more projection matrices
#'@param n0 initial population vector
#'@param tmax number of time steps or projection intervals to predict future
#'population size
...
#'@param nmax a maximum number of individuals beyond which population
#'projections cannot exceed.  Default is no density dependence
...
#'@return A matrix listing final population sizes by stage class with one
#'iteration per row.
...
#'@source converted Matlab code from Box 7.3 in Morris and Doak (2002) with
#'nmax option added to introduce simple density dependence
#'@keywords survey
#'@examples
#'
#'data(hudsonia)
