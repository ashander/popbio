...
#'@param ...  additional options passed to \code{\link{projection.matrix}}
#'@return A list with 3 items \item{lambda }{A vector containing bootstrap
#'values for lambda} \item{matrix }{A matrix containing bootstrap transtion
#'matrices with one projection matrix per row.} \item{vector }{A matrix
#'containing bootstrap stage vectors with one stage vector per row.}
#'@author Chris Stubben
#'@seealso \code{\link{projection.matrix}}
#'@references see Morris and Doak 2005 in
#'\url{http://esapubs.org/Archive/mono/M075/004/appendix-A.htm} for resampling
#'by stage class counts
#'@keywords survey
#'@examples
#'
#'
