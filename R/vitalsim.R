#'Calculate stochastic growth rate and extinction time CDF using vital rates
#'with within-year, auto-, and cross-correlations
#'
#'This function runs a series of stochastic PVA population projections by
#'sampling vital rates from a beta, stretched beta, or lognormal distribution
...
#'@param yrspan the number of years of correlations to build into the M12
#'matrix
...
#'@param vrtypes identifies the distribution for each rate in vrmeans where 1 =
#'beta, 2 = stretched beta, 3 = lognormal, default is all ones
...
#'@return The function plots a histogram of log stochastic growth rates and the
#'cumulative probability of quasi-extinction and returns a list with 4 items:
#'\item{detLambda}{the deterministic population growth rate computed from the
#'mean matrix} \item{stochlambda}{the mean stochastic growth rate with 95\%
#'confidence intervals.} \item{logLambdas}{ a vector of all log stochastic
#'growth rates in first plot} \item{CDFExt}{a vector of cumulative
#'probabilities of quasi-extinction in second plot}
#'@note The correlation matrices for \emph{Hudsonia} in
#'\url{http://www.sinauer.com/PVA/hudcorrs.mat} include some correlations>1.  A
#'corrected set of correlations was sent by D. Doak on 8/4/2007.  Therefore the
#'results from the simulation below are different than the book.
#'@author Original MATLAB program by Morris and Doak (2002: 301 - 304). Adapted
#'to R by Patrick Nantel, 12 July 2005.
#'@seealso \code{\link{hudmxdef}}, \code{\link{hudvrs}} and
#'\code{\link{hudcorrs}}
